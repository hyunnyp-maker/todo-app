...
**반복 일정** — 매일 · 평일(월~금) · 주말(토·일) · 매주 특정 요일 · 매월 특정 날짜 · 매년 특정 날짜.
매주에서는 `평일`·`주말`을 한 번에 채운 뒤 요일을 개별로 다듬을 수 있습니다. 종료일은 선택입니다.
...
반복(매일 · 평일마다 · 주말마다 · 매주 월요일 · 매주 화요일과 목요일 · 매월 25일 · 매년 3월 5일)입니다.
